# -*- coding: utf-8 -*-
#
# direct_mail return mail analysis scheduler task documentation build configuration file, created by
# TYPO3 extension sphinx on Sat, 05 Oct 2013 22:19:55 +0200.
#
...
project = u'direct_mail return mail analysis scheduler task'
copyright = u'2013, Johannes Feustel'
...
htmlhelp_basename = 'direct_mailreturnmailanalysisschedulertaskdoc'
...
latex_documents = [
    ('Index', 'direct_mailreturnmailanalysisschedulertask.tex', u'direct_mail return mail analysis scheduler task',
     u'Johannes Feustel', 'manual'),
]
...
pdf_documents = [
    ('Index', 'direct_mailreturnmailanalysisschedulertask', u'direct_mail return mail analysis scheduler task',
     u'Johannes Feustel'),
]
...
texinfo_documents = [
    ('Index', 'direct_mailreturnmailanalysisschedulertask', u'direct_mail return mail analysis scheduler task',
     u'Johannes Feustel', 'direct_mail return mail analysis scheduler task', 'One line description of project.',
     'Miscellaneous'),
]
